...
function RegisterPage() {
  ...
  const handleGoogleRegister = () => {
    setError('Google registration akan segera tersedia');
  };
      ...
      <div className="auth-main">
        <div className="form-box">
          ...
          <form onSubmit={handleSubmit}>
              ...
              <div className="input-box">
                <input 
                  ...
                  style={{ 
                    ...
                    borderColor: fieldErrors.fullName ? '#dc2626' : '#e2e8f0'
                  }}
                />
              </div>
            ...
            <div className="field">
              ...
              <div className="input-box">
                <input
                  ...
                  style={{ 
                    backgroundColor: loading ? '#f3f4f6' : 'white',
                    borderColor: fieldErrors.confirmPassword ? '#dc2626' : '#e2e8f0'
                  }}
                />
                <button 
                  type="button" 
            ...
            {fieldErrors.terms && (
              <small style={{ color: '#dc2626', fontSize: '0.75rem', marginTop: '-10px', marginBottom: '10px', display: 'block' }}>
                {fieldErrors.terms}
              </small>
            )}
