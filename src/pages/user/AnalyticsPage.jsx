            ...
            <Row className="g-4">
              ...
              <Col xl={8} lg={7} className="d-flex flex-column gap-4">
                  ...
                  <Card.Body className="p-4 p-xl-4 pb-xl-3">
                    ...
                    <div className="mt-3 d-flex justify-content-center">
                      <div className="an-trend-banner d-inline-flex align-items-center gap-2">
                        ...
                        <span className="text-muted small">· Average increase of 4.2% per month</span>
                      </div>
                    </div>
                  </Card.Body>
                </Card>
                ...
                <div className="mt-2 anim-fade-up anim-d3">
                  ...
                  <Row className="g-3">
                    {[
                      { icon: Utensils, cls: "insight-warning", iconCls: "text-warning", text: "Your food spending increased by 18% compared to last month" },
                      { icon: Tv,       cls: "insight-good",    iconCls: "text-success", text: "You spent less on entertainment this month. Great job!"    },
                      { icon: Car,      cls: "insight-suggestion", iconCls: "text-primary", text: "Transportation cost are steady. Consider carpooling to save more" },
              ...
              <Col xl={4} lg={5} className="d-flex flex-column gap-4">
                  ...
                  <Card.Body className="p-4 p-xl-4 pb-4">
                    ...
                    <div className="d-flex justify-content-center align-items-center mt-3 mb-2" style={{ height: 200 }}>
                      <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                          <Pie data={categoryData} cx="50%" cy="50%" innerRadius={65} outerRadius={95} paddingAngle={2} dataKey="value" stroke="none">
                    ...
                    <div className="px-2">
                      {categoryData.map((item, idx) => (
                        <div key={idx} className="d-flex align-items-center justify-content-between mb-2 pb-1 small">
                          ...
                          <div className="fw-bold text-dark text-end ms-2" style={{ width: "60px" }}>${item.value}</div>
                          <div className="text-muted text-end" style={{ width: "45px" }}>{item.percent}</div>
                        </div>
                      ))}
                    </div>
                  </Card.Body>
                ...
                <Card className="border-0 shadow-sm rounded-4 an-card card-hover anim-fade-right anim-d2">
                  <Card.Body className="p-4 p-xl-4">
                    ...
                    <p className="text-muted small mb-4">March 2026</p>
                    <div className="d-flex align-items-center gap-3 mb-4">
                      <div className="an-icon-box bg-success bg-opacity-10 text-success"><Utensils size={24} /></div>
                      <div>
                ...
                <Card className="border-0 shadow-sm rounded-4 an-card card-hover anim-fade-right anim-d3">
                  <Card.Body className="p-4 p-xl-4">
                    ...
                    <p className="text-muted small mb-0">You spent $250 more this month</p>
                  </Card.Body>
                </Card>
